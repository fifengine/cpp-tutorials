...
namespace FIFE
{
	 ...
	 */
	class IMapLoader : public FifeClass
	{
	public:
		IMapLoader() { }
		virtual ~IMapLoader() { }
		 ...
		 */
		virtual Map* loadMapFile(const ResourceLocation& location) { return 0; }

		/** determines whether the resource is in
		 *	the correct format for this loader
		 */
		virtual bool isLoadable(const ResourceLocation& location) const { return false; }
	};
}
